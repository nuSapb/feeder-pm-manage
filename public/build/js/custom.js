...
function init_chart_doughnut() {
  ...
  if ($(".canvasDoughnut").length) {
    var chart_doughnut_settings = {
      ...
      data: {
        labels: ["8 mm.", "12 mm.", "16 mm.", "24 mm."],
        datasets: [
          {
            data: [78.78, 26.18, 21.42, 10],
...
function init_charts() {
  ...
  if ($("#canvasDoughnutIndex").length) {
    var ctx = document.getElementById("canvasDoughnutIndex")
    var data = {
      labels: [
        "Dark Grey",
        "Purple Color",
    ...
    var canvasDoughnutIndex = new Chart(ctx, {
      type: "doughnut",
      tooltipFillColor: "rgba(51, 51, 51, 0.55)",
      data: data
    })
